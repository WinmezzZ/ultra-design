...
const MenuComponent = forwardRef<HTMLUListElement, React.PropsWithChildren<MenuProps>>((p, ref) => {
...
MenuComponent.displayName = 'UltraMenu';

const Menu = withStyle(MenuComponent);
